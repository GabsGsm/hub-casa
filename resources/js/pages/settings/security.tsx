                        ...
                        {twoFactorEnabled ? (
                            <div className="flex flex-col items-start justify-start space-y-4">
                                <p className="text-sm text-muted-foreground">
                                    Você será solicitado a informar um PIN seguro
                                    durante o login, que pode ser obtido pelo
                                    aplicativo de autenticação TOTP no seu
                                    celular.
                                </p>
                            ...
                            <div className="flex flex-col items-start justify-start space-y-4">
                                <p className="text-sm text-muted-foreground">
                                    ...
                                    você será solicitado a informar um PIN
                                    seguro durante o login. Esse PIN pode ser
                                    obtido pelo aplicativo de autenticação TOTP
                                    no seu celular.
                                </p>
